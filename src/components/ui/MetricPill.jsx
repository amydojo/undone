...
export default function MetricPill({ metric, dark = false, compact = false, className }) {
  return (
    <div className={cx(compact ? "min-w-0 px-3 py-3 sm:py-4 lg:px-4 xl:px-5 xl:py-6" : "min-w-0 px-3 py-4 lg:px-4 xl:px-5 xl:py-6", className)}>
