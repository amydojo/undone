          ...
          return (
            ...
            >
              ...
              <div className='min-w-0 flex-1'>
                ...
                <p className='truncate text-[9px] uppercase tracking-[0.12em] text-[#11100d]/34'>{presentation.format}</p>
              </div>
        ...
        >
          {!componentVisual && (
            <>
              ...
              <h4 className='text-[13px] font-medium leading-5 text-[#11100d]'>{selectedPresentation.name}</h4>
            </>
          )}
