export const profile = {
  name: "Amy Do",
  positioning: "Product-minded design technologist building brand, growth, AI, and workflow systems.",
  oneSentence:
    "I turn messy business, product, and workflow problems into clear systems, interfaces, and proof-backed execution.",
  ...
  currentFocus: ["AI assisted workflows", "brand systems", "follow-up logic", "internal tools"],
